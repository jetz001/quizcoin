...
import { prisma, getLeavesForBatch, getBatch } from '../database/index.js';
import { merkleContract } from '../../config/blockchain.js';
import { CONFIG } from '../../config/constants.js';
import { updateQuestionMerkleRoot } from '../blockchain/contracts/smartContract.js';
...
export const buildMerkleFromBatch = async (batchId) => {
  ...
  return { rootHex, leaves: leafHashes };
};
